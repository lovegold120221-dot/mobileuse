...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
    ...
    try {
      ...
      if (action != null) {
        ...
        final result = await _actionHandler.execute(
          ...
          onProgress: (msg) {
            developer.log('Task progress: $msg', name: 'MobileUse Agent');
  ...
  Future<void> _showTaskProgressOverlay(String message) async {
    ...
    // Never cover MobileUse Agent itself. The lifecycle observer will create the
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 12),
                Text('MobileUse Agent', style: headerStyle),
              ],
            ),
          ),

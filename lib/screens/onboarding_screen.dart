    ...
    await showDialog<void>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: const Text(
          ...
          'and open Accessibility Settings to enable MobileUse Agent Screen Control.',
        ),
        actions: [
          TextButton(
            onPressed: () {
      ...
      if (models.isNotEmpty ||
        ...
        if (mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: const Text(
                'Configuration validated! Launching MobileUse Agent...',
              ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            "World's first mobile-use agent by Eburon AI. MobileUse Agent can navigate apps, perform operations, and speak with you.",
              ...
              children: [
                ...
                if (FeatureFlags.floatingOverlayEnabled) ...[
                  ...
                  _buildPermissionCard(
                    ...
                    'Allows MobileUse Agent to show a floating overlay bubble when backgrounded or executing a task so you can monitor progress and execute actions.',
                ...
                _buildPermissionCard(
                  'Notifications',
                  'Allows MobileUse Agent to show ongoing tasks, alerts, and execution updates in your notification tray.',

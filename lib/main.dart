...
void main() async {
  ...
  runApp(MobileUseAgentApp(onboardingCompleted: onboardingCompleted));
}

class MobileUseAgentApp extends StatelessWidget {
  final bool onboardingCompleted;
  const MobileUseAgentApp({super.key, required this.onboardingCompleted});
